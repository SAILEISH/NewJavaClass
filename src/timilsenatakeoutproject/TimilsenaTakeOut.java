package timilsenatakeoutproject;

import java.util.Scanner;

public class TimilsenaTakeOut {
    ...
    public static void main(String[] args) {
        ...
        while (true){
            ...
            if (number_of_guests >= 10) {
                ...
                TimilsenaTakeOut.displayMainMenu();
                food_type=input.nextInt();

                switch(food_type){

                    case 1:
                        TimilsenaTakeOut.displayItalianFoodMenu();
                ...
                System.out.println("Number of guests must be greater or equal to 10");
            }
        }
    }
}
